...
pixi add ampform-dpd
# for installing globally
pixi global install ampform-dpd
```
...
It is possible to list all of the versions of `ampform-dpd` available on your platform:
...
```
pixi search ampform-dpd --channel conda-forge
```
